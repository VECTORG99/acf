...
- **Type label**: `bug`, `enhancement`, `documentation`, `refactor`, `chore`, `test`
- **Priority label**: `priority:P0` | `priority:P1` | `priority:P2` | `priority:P3`
- **Area label**: `area:backend` | `area:frontend` | `area:ci` | `area:docs` | `area:security`
- **Status label**: `ready-to-implement` (if ready for autonomous work)
